...
const fields = ref([
  ...
  { label: 'Alat Transportasi', key: 'alat_transportasi', type: 'text' },
  ...
  { label: 'Penerima KPS', key: 'penerima_kps', type: 'text' },
  ...
  { label: 'No Peserta Ujian', key: 'no_peserta_ujian', type: 'text' },
  { label: 'No Seri Ijazah', key: 'no_seri_ijazah', type: 'text' },
  { label: 'Penerima', key: 'penerima', type: 'text' },
  ...
  { label: 'Nomor Rekening', key: 'nomor_rekening', type: 'text' },
  { label: 'Rekening Atas', key: 'rekening_atas', type: 'text' },
